...
public class Splitter extends XMLFilterImpl {
    ...
    public void startElement(String namespaceURI, String localName, String qName, Attributes atts)
        ...
        if( namespaceURI.equals("") && localName.equals("taxonomies") ) {
    ...
    public void endElement(String namespaceURI, String localName, String qName) throws SAXException {
        ...
        if( depth!=0 ) {
            ...
            if( depth==0 ) {
                ...
                try {
                    JAXBElement<Taxonomies> result = 
			(JAXBElement<Taxonomies>)unmarshallerHandler.getResult();
                    ...
                    System.err.println("unable to process an Node at line "+
    ...
    public void process( Taxonomies taxonomies ) {
//        System.out.println("Taxonomy names "
//            + taxonomies.getTaxonomy().getTaxonomyName() );
//    
    }
